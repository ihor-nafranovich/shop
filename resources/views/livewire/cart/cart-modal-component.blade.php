            ...
            <div class="table-responsive">
                <table class="table offcanvasCart-table">
                    ...
                    @foreach($cart as $id => $item)
                        <tr wire:key="{{ $id }}">
                            <td class="product-img-td"><a href="{{ route('product', $item['slug']) }}" wire:navigate><img src="{{ asset($item['image']) }}" alt=""></a>
                            </td>
                            <td><a href="{{ route('product', $item['slug']) }}" wire:navigate>{{ $item['title'] }}</a></td>
                            <td>${{ $item['price'] }}</td>
